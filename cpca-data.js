    ...
    },
    {
        ...
        'city':[
            ...
            },
            {
                'name':'保定市',
                'area':[
                "竞秀区","莲池区","满城区","清苑区","徐水区","涞水县","阜平县","定兴县","唐县","高阳县","容城县","涞源县","望都县","安新县","易县","曲阳县","蠡县","顺平县","博野县","雄县","涿州市","安国市","高碑店市"
                ]
            },
            {
                'name':'张家口市',
            ...
            },
            {
                'name':'衡水市',
                'area':[
                "桃城区","冀州区","枣强县","武邑县","武强县","饶阳县","安平县","故城县","景县","阜城县","深州市"
                ]
            },
            {
                'name':'省直辖县级行政区划',
        ...
        'city':[
            {
                'name':'长春市',
                'area':[
                "南关区","宽城区","朝阳区","二道区","绿园区","双阳区","九台区","农安县","榆树市","德惠市"
                ]
            },
            {
                'name':'吉林市',
        ...
        'city':[
            {
                'name':'杭州市',
                'area':[
                "上城区","下城区","江干区","拱墅区","西湖区","滨江区","萧山区","余杭区","富阳区","桐庐县","淳安县","建德市","临安市"
                ]
            },
            {
                'name':'宁波市',
    ...
    },
    {
        ...
        'city':[
            ...
            },
            {
                'name':'九江市',
                'area':[
                "濂溪区","浔阳区","九江县","武宁县","修水县","永修县","德安县","都昌县","湖口县","彭泽县","瑞昌市","共青城市","庐山市"
                ]
            },
            {
                'name':'新余市',
            ...
            },
            {
                'name':'赣州市',
                'area':[
                "章贡区","南康区","赣县","信丰县","大余县","上犹县","崇义县","安远县","龙南县","定南县","全南县","宁都县","于都县","兴国县","会昌县","寻乌县","石城县","瑞金市"                  
                ]
            },
            {
                'name':'吉安市',
    ...
    },
    {
        ...
        'city':[
            ...
            },
            {
                'name':'青岛市',
                'area':[
                "市南区","市北区","黄岛区","崂山区","李沧区","城阳区","胶州市","即墨市","平度市","莱西市"
                ]
            },
            {
                'name':'淄博市',
            ...
            },
            {
                'name':'临沂市',
                'area':[
                "兰山区","罗庄区","河东区","沂南县","郯城县","沂水县","兰陵县","费县","平邑县","莒南县","蒙阴县","临沭县"
                ]
            },
            {
                'name':'德州市',
    ...
    },
    {
        ...
        'city':[
            ...
            },
            {
                'name':'开封市',
                'area':[
                "龙亭区","顺河回族区","鼓楼区","禹王台区","金明区","祥符区","杞县","通许县","尉氏县","兰考县"
                ]
            },
            {
                'name':'洛阳市',
    ...
    },
    {
        ...
        'city':[
            ...
            },
            {
                'name':'永州市',
                'area':[
                "零陵区","冷水滩区","祁阳县","东安县","双牌县","道县","江永县","宁远县","蓝山县","新田县","江华瑶族自治县"
                ]
            },
            {
                'name':'怀化市',
    ...
    },
    {
        ...
        'city':[
            ...
            },
            {
                'name':'东莞市',
                'area':[
                "东城街道办事处","南城街道办事处","万江街道办事处","莞城街道办事处","石碣镇","石龙镇","茶山镇","石排镇","企石镇","横沥镇","桥头镇","谢岗镇","东坑镇","常平镇","寮步镇","樟木头镇","大朗镇","黄江镇","清溪镇","塘厦镇","凤岗镇","大岭山镇","长安镇","虎门镇","厚街镇","沙田镇","道滘镇","洪梅镇","麻涌镇","望牛墩镇","中堂镇","高埗镇","松山湖管委会","虎门港管委会","东莞生态园"
                ]
            },
            {
                'name':'中山市',
                'area':[
                "石岐区街道办事处","东区街道办事处","火炬开发区街道办事处","西区街道办事处","南区街道办事处","五桂山街道办事处","小榄镇","黄圃镇","民众镇","东凤镇","东升镇","古镇镇","沙溪镇","坦洲镇","港口镇","三角镇","横栏镇","南头镇","阜沙镇","南朗镇","三乡镇","板芙镇","大涌镇","神湾镇"
                ]
            },
            {
                'name':'潮州市',
        ...
        'city':[
            {
                'name':'南宁市',
                'area':[
                "兴宁区","青秀区","江南区","西乡塘区","良庆区","邕宁区","武鸣区","隆安县","马山县","上林县","宾阳县","横县"
                ]
            },
            {
                'name':'柳州市',
        ...
        'city':[
            {
                'name':'重庆市辖区',
                'area':[
                "万州区","涪陵区","渝中区","大渡口区","江北区","沙坪坝区","九龙坡区","南岸区","北碚区","綦江区","大足区","渝北区","巴南区","黔江区","长寿区","江津区","合川区","永川区","南川区","璧山区","铜梁区","潼南区","荣昌区","开州区"
                ]
            },
            {
                'name':'重庆辖县',
        ...
        'city':[
            {
                'name':'成都市',
                'area':[
                "锦江区","青羊区","金牛区","武侯区","成华区","龙泉驿区","青白江区","新都区","温江区","双流区","金堂县","郫县","大邑县","蒲江县","新津县","都江堰市","彭州市","邛崃市","崇州市","简阳市"],"自贡市":["自流井区","贡井区","大安区","沿滩区","荣县","富顺县"],"攀枝花市":["东区","西区","仁和区","米易县","盐边县"],"泸州市":["江阳区","纳溪区","龙马潭区","泸县","合江县","叙永县","古蔺县"],"德阳市":["旌阳区","中江县","罗江县","广汉市","什邡市","绵竹市"
                ]
            },
            {
                'name':'绵阳市',
    ...
    },
    {
        ...
        'city':[
            ...
            },
            {
                'name':'毕节市',
                'area':[
                "七星关区","大方县","黔西县","金沙县","织金县","纳雍县","威宁彝族回族苗族自治县","赫章县"
                ]
            },
            {
                'name':'铜仁市',
        ...
        'city':[
            {
                'name':'拉萨市',
                'area':[
                "城关区","堆龙德庆区","林周县","当雄县","尼木县","曲水县","达孜县","墨竹工卡县"
                ]
            },
            {
                'name':'日喀则市',
        ...
        'city':[
            {
                'name':'台北市',
                'area':[
                '松山区','大安区','大同区','中山区','内湖区','南港区','士林区','北投区','信义区','中正区','万华区','文山区'
                ]
            },
            {
                'name':'新北市',
                'area':[
                '板桥区','三重区','永和区','中和区','新庄区','新店区','土城区','芦洲区','汐止区','树林区','莺歌区','三峡区','淡水区','瑞芳区','五股区','泰山区','林口区','深坑区','石碇区','坪林区','三芝区','石门区','八里区','平溪区','双溪区','贡寮区','金山区','万里区','乌来区'
                ]
            },
            {
                'name':'台北市',
            ...
            },
            {
                'name':'台中市',
                'area':[
                '中区','东区','南区','西区','北区','北屯区','西屯区','南屯区','太平区','大里区','雾峰区','乌日区','丰原区','后里区','东势区','石冈区','新社区','和平区','神冈区','潭子区','大雅区','大肚区','龙井区','沙鹿区','梧栖区','清水区','大甲区','外埔区','大安区'
                ]
            },
            {
                'name':'台南市',
                'area':[
                '南区','东区','北区','中西区','安平区','安南区','永康区','新营区','盐水区','白河区','麻豆区','佳里区','新化区','善化区','学甲区','柳营区','后壁区','东山区','下营区','六甲区','官田区','大内区','西港区','七股区','将军区','北门区','安定区','楠西区','新市区','山上区','玉井区','南化区','左镇区','仁德区','归仁区','关庙区','龙崎区'
                ]
            },
            {
                'name':'高雄市',
                'area':[
                '盐埕区','鼓山区','左营区','楠梓区','三民区','新兴区','前金区','苓雅区','前镇区','旗津区','小港区','凤山区','冈山区','旗山区','美浓区','林园区','大寮区','大树区','仁武区','大社区','鸟松区','桥头区','燕巢区','田寮区','阿莲区','路竹区','湖内区','茄萣区','永安区','弥陀区','梓官区','六龟区','甲仙区','杉林区','内门区','茂林区','桃源区','那玛夏区'
                ]
            },
            {
                'name':'基隆市',
            ...
            },
            {
                'name':'桃园县',
                'area':[
                '桃园市','中坜市','平镇市','八德市','杨梅市','大溪镇','芦竹乡','大园乡','龟山乡','龙潭乡','新屋乡','观音乡','复兴乡'
                ]
            },
            {
                'name':'新竹县',
                'area':[
                '竹北市','关西镇','新埔镇','竹东镇','湖口乡','横山乡','新丰乡','芎林乡','宝山乡','北埔乡','峨眉乡','尖石乡','五峰乡'
                ]
            },
            {
                'name':'苗栗县',
                'area':[
                '苗栗市','苑里镇','通霄镇','竹南镇','头份镇','后龙镇','卓兰镇','大湖乡','公馆乡','铜锣乡','南庄乡','头屋乡','三义乡','西湖乡','造桥乡','三湾乡','狮潭乡','泰安乡'
                ]
            },
            {
                'name':'彰化县',
                'area':[
                '彰化市','鹿港镇','和美镇','北斗镇','员林镇','溪湖镇','田中镇','二林镇','线西乡','伸港乡','福兴乡','秀水乡','花坛乡','芬园乡','大村乡','埔盐乡','埔心乡','永靖乡','社头乡','二水乡','田尾乡','埤头乡','芳苑乡','大城乡','竹塘乡','溪州乡'
                ]
            },
            {
                'name':'南投县',
                'area':[
                '南投市','埔里镇','草屯镇','竹山镇','集集镇','名间乡','鹿谷乡','中寮乡','鱼池乡','国姓乡','水里乡','信义乡','仁爱乡'
                ]
            },
            {
                'name':'云林县',
                'area':[
                '斗六市','斗南镇','虎尾镇','西螺镇','土库镇','北港镇','古坑乡','大埤乡','莿桐乡','林内乡','二仑乡','仑背乡','麦寮乡','东势乡','褒忠乡','台西乡','元长乡','四湖乡','口湖乡','水林乡'
                ]
            },
            {
                'name':'嘉义县',
                'area':[
                '太保市','朴子市','大林镇','布袋镇','民雄乡','溪口乡','新港乡','六脚乡','东石乡','义竹乡','鹿草乡','水上乡','中埔乡','竹崎乡','梅山乡','番路乡','大埔乡','阿里山乡'
                ]
            },
            {
                'name':'屏东县',
                'area':[
                '屏东市','潮州镇','东港镇','恒春镇','万丹乡','长治乡','麟洛乡','九如乡','里港乡','盐埔乡','高树乡','万峦乡','内埔乡','竹田乡','新埤乡','枋寮乡','新园乡','崁顶乡','林边乡','南州乡','佳冬乡','琉球乡','车城乡','满州乡','枋山乡','雾台乡','玛家乡','泰武乡','来义乡','春日乡','狮子乡','牡丹乡','三地门乡'
                ]
            },
            {
                'name':'宜兰县',
                'area':[
                '宜兰市','罗东镇','苏澳镇','头城镇','礁溪乡','壮围乡','员山乡','冬山乡','五结乡','三星乡','大同乡','南澳乡'
                ]
            },
            {
                'name':'花莲县',
                'area':[
                '花莲市','凤林镇','玉里镇','新城乡','吉安乡','寿丰乡','光复乡','丰滨乡','瑞穗乡','富里乡','秀林乡','卓溪乡','万荣乡'
                ]
            },
            {
                'name':'台东县',
                'area':[
                '台东市','成功镇','关山镇','卑南乡','大武乡','东河乡','长滨乡','鹿野乡','池上乡','绿岛乡','延平乡','海端乡','达仁乡','金峰乡','兰屿乡','太麻里乡'
                ]
            },
            {
                'name':'澎湖县',
                'area':[
                '马公市','湖西乡','白沙乡','西屿乡','望安乡','七美乡'
                ]
            },
            {
                'name':'金门县',
                'area':[
                '金城镇','金湖镇','金沙镇','金宁乡','烈屿乡','乌丘乡'
                ]
            },
            {
                'name':'连江县',
